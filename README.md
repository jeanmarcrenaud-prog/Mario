...
2️⃣ Crée un environnement virtuel
python -m venv venv
...
Interagir avec l’assistant via :

Micro (audio_input_microphone, mock pour test)

Console (ConsoleView)

Web (Gradio : WebInterfaceGradio)

ePaper (EPaperView)

TTS et STT modulaires
