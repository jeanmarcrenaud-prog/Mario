...
from src.controller.wake_word_controller import WakeWordController
#from ..core.speech_recognition import SpeechRecognizer
from src.controller.speech_controller import SpeechRecognizer
...
from src.view.interface_helpers import InterfaceHelpers
from .analysis_manager import AnalysisManager
import pyaudio

class GradioInterface:
    def __init__(self, speech_recognizer= None, tts=None):
        self.wake_detector = WakeWordController()
    ...
    def _create_control_panel(self):
        ...
        self.piper_dropdown = gr.Dropdown(
            ...
            value=ConfigManager.DEFAULT_PIPER_VOICE,
        )
